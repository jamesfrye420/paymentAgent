    ...
    def from_env(cls) -> "Config":
        ...
        return cls(
            ...
            circuit_breaker_half_open_max_calls=int(
                os.getenv("CIRCUIT_BREAKER_HALF_OPEN_CALLS", "3")
            ),
            ...
            provider_rate_limit_threshold=int(
                os.getenv("PROVIDER_RATE_LIMIT_THRESHOLD", "100")
            ),
            provider_rate_limit_window=int(
                os.getenv("PROVIDER_RATE_LIMIT_WINDOW", "60")
            ),
        )
