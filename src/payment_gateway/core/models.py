...
from .enums import (
    PaymentStatus, CardNetwork, PaymentMethod, Currency, 
    TransactionType, RiskLevel, Region
)
...
class Transaction:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'payment_instrument': self.payment_instrument.to_dict() if self.payment_instrument else None,
...
class ProviderHealth:
    ...
    network_success_rates: Dict[str, float] = field(default_factory=dict)  # Per card network
    method_success_rates: Dict[str, float] = field(default_factory=dict)   # Per payment method
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'circuit_breaker_last_failure': (
                ...
                if self.circuit_breaker_last_failure else None
            ),
...
class RetryConfig:
    ...
    retry_on_errors: List[str] = field(default_factory=lambda: [
        "TIMEOUT", "CONNECTION_REFUSED", "NETWORK_TIMEOUT", "PROVIDER_MAINTENANCE"
    ])
